...
// Process icons from the illustrative logo - white/light colors for purple background
  ...
  return {
    Magnet: ({ className }: { className?: string }) => (
      <svg className={cn('w-16 h-16', className)} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <rect x="25" y="15" width="15" height="20" fill="white" rx="2" />
        <rect x="60" y="15" width="15" height="20" fill="#c4b5fd" rx="2" />

        {/* Lead icons (people) */}
        <circle cx="40" cy="75" r="3" fill="white" />
        <circle cx="50" cy="78" r="3" fill="#c4b5fd" />
        <circle cx="60" cy="76" r="3" fill="white" />
        <circle cx="45" cy="82" r="3" fill="white" opacity="0.7" />
        <circle cx="55" cy="80" r="3" fill="#c4b5fd" opacity="0.7" />
      </svg>
    ),
    ...
    Funnel: ({ className }: { className?: string }) => (
      <svg className={cn('w-16 h-16', className)} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="50" cy="70" r="2.5" fill="#c4b5fd" />
      </svg>
    ),
    ...
    Meeting: ({ className }: { className?: string }) => (
      <svg className={cn('w-16 h-16', className)} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Calendar */}
        <rect x="20" y="25" width="35" height="45" rx="4" fill="white" stroke="white" strokeWidth="3" />
        <rect x="20" y="25" width="35" height="10" rx="4" fill="#c4b5fd" />
        <path d="M28 35 L28 38 M35 35 L35 38 M42 35 L42 38 M47 35 L47 38" stroke="#7c3aed" strokeWidth="2" />

        {/* Checkmark */}
        <path d="M28 50 L33 55 L43 42" stroke="#7c3aed" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />

        {/* Two people shaking hands */}
        <circle cx="62" cy="45" r="8" fill="white" />
        <path d="M62 53 L62 70" stroke="white" strokeWidth="5" strokeLinecap="round" />

        <circle cx="78" cy="45" r="8" fill="#c4b5fd" />
        <path d="M78 53 L78 70" stroke="#c4b5fd" strokeWidth="5" strokeLinecap="round" />

        {/* Handshake connection */}
        <path d="M58 58 L82 58" stroke="white" strokeWidth="4" strokeLinecap="round" />
      </svg>
    ),
  };
}
